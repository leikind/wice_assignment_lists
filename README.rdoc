...
Run the generator to copy the javascript, the stylesheet, and the icons to public, and the configuration file to <tt>config/initializers</tt>:

   ./script/generate  assignment_lists_assets
...
This generator copies two javascript files into <tt>public/javascripts</tt> -
<tt>assignment_lists_prototype.js</tt> and <tt>assignment_lists_jquery.js</tt>.

=== Prototype

For a Prototype based app, just delete <tt>assignment_lists_jquery.js</tt> and add require the correct 
javascript file in your layout:

     <%= javascript_include_tag 'assignment_lists_prototype' %>

=== jQuery

For a jQuery based app, edit <tt>config/initializers/ass_lists_config.rb</tt> and change
...
Then delete <tt>assignment_lists_prototype.js</tt> and add require the correct 
javascript file in your layout:
